...
static int mk_write_uint( mk_context *c, unsigned id, int64_t ui )
{
    unsigned char c_ui[8] = {
        static_cast<unsigned char>(ui >> 56),
        static_cast<unsigned char>(ui >> 48),
        static_cast<unsigned char>(ui >> 40),
        static_cast<unsigned char>(ui >> 32),
        static_cast<unsigned char>(ui >> 24),
        static_cast<unsigned char>(ui >> 16),
        static_cast<unsigned char>(ui >> 8),
        static_cast<unsigned char>(ui) };
    unsigned i = 0;
